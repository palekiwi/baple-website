export const frontmatter = {
  ...
  sections: {
    intro: {
      ...
      image: "../../../images/metal-packaging/Valve_1.jpg",
      body: [
    ...
    categoryList: {
      categoryItems: [
        {
          heading: "Válvulas de Aerosol",
          image: "../../../images/metal-packaging/Metal Packaging_Valves.jpg",
          body: [
              ...
              params: [
                {
                  key: "Tipos",
                  value:
                    "Llenado Rápido, 360 grados,Recarga de Gas, Gas de Cocina, Medición, Mousee, Polvo, Pintura",
                },
              ],
            },
          ],
